...
NAI = {
	...
	MANPOWER_FREE_USAGE_THRESHOLD = 5000,			-- If AI has this much manpower he doesn't care about the percentage
	MANPOWER_RESERVED_THRESHOLD = 0.01,					-- The AI will not deploy more units if he goes below this percentage
